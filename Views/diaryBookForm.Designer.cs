namespace ANF.Views
{
	partial class diaryBookForm
	{
		...
		private void InitializeComponent()
		{
			...
			tbl_Departures = new DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)tbl_Departures).BeginInit();
			...
			tableLayoutPanel4.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
			tableLayoutPanel4.Controls.Add(tbl_Departures, 0, 0);
			tableLayoutPanel4.Dock = DockStyle.Top;
			tableLayoutPanel4.Location = new Point(3, 165);
			...
			// tbl_Departures
			// 
			tbl_Departures.AllowUserToAddRows = false;
			tbl_Departures.AllowUserToDeleteRows = false;
			tbl_Departures.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			tbl_Departures.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
			tbl_Departures.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
			tbl_Departures.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			tbl_Departures.Location = new Point(3, 3);
			tbl_Departures.Name = "tbl_Departures";
			tbl_Departures.ReadOnly = true;
			tbl_Departures.RowHeadersWidth = 51;
			tbl_Departures.Size = new Size(888, 359);
			tbl_Departures.TabIndex = 0;
			// 
			// tableLayoutPanel2
			// 
			...
			tableLayoutPanel5.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 40.6944427F));
			tableLayoutPanel5.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 59.3055573F));
			tableLayoutPanel5.Controls.Add(button1, 1, 0);
			tableLayoutPanel5.Controls.Add(dateTimePicker1, 0, 0);
			tableLayoutPanel5.Location = new Point(152, 3);
			tableLayoutPanel5.Name = "tableLayoutPanel5";
			tableLayoutPanel5.RowCount = 1;
			tableLayoutPanel5.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
			tableLayoutPanel5.Size = new Size(637, 41);
			...
			button2.Location = new Point(795, 6);
			...
			((System.ComponentModel.ISupportInitialize)tbl_Departures).EndInit();
		...
		private DataGridView tbl_Departures;
